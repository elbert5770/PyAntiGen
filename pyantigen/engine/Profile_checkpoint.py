...
# seconds with the complete Nelder-Mead state (pyantigen.engine.Nelder_mead), and a later
...
def solver_fingerprint(replicates):
    ...
    # not in any settings dict -- they live in pyantigen.engine.Simulate -- but a run with
    ...
    try:
        from pyantigen.engine.Simulate import _DUST_THRESHOLD, _MIN_ABSOLUTE_TOLERANCE
        entries["__engine__"] = {
